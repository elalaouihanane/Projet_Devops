<?php $__env->startSection('title', 'Inscription — Trendora'); ?>
<?php $__env->startSection('brand_title', 'Bienvenue sur Trendora.'); ?>
<?php $__env->startSection('brand_subtitle', 'Créez votre compte et commencez à partager vos looks.'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="auth-card" data-register>
        ...
        <form class="auth-form" method="POST" action="<?php echo e(route('register')); ?>" enctype="multipart/form-data" novalidate>
            <?php echo csrf_field(); ?>

            <input type="hidden" name="name" value="<?php echo e(old('name')); ?>" data-fullname>
            <input type="hidden" name="style_prefere" value="<?php echo e(old('style_prefere')); ?>" data-style-hidden>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="step-actions">
                    <span class="step-hint">Déjà un compte ? <a class="link" href="<?php echo e(url('/login')); ?>">Se connecter</a></span>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="field">
                    ...
                    <textarea id="bio" name="bio" rows="3" maxlength="280" placeholder="Quelques mots sur votre univers..." data-bio><?php echo e(old('bio')); ?></textarea>
                    <?php $__errorArgs = ['bio'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
                ...
                <div class="field">
                    ...
                    <div class="chips" role="listbox" aria-label="Choisir un style préféré">
                        ...
                        <?php $__currentLoopData = $styles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $style): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <button
                                type="button"
                                class="chip <?php echo e($oldStyle === $style ? 'is-selected' : ''); ?>"
                                data-style="<?php echo e($style); ?>"
                                aria-pressed="<?php echo e($oldStyle === $style ? 'true' : 'false'); ?>"
                            >
                                <?php echo e($style); ?>
